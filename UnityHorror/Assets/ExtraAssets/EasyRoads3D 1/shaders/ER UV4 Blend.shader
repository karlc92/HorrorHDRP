// © 2022 EasyRoads3D
// This shader blends two textures by vertex color. The second map uses UV4 coordinates.
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult41 = lerp( ( SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, uv_MainTex ) * _Color ) , ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, texCoord11 ) * _Color0 ) , packedInput.ase_color.a);
				
				float2 texCoord24 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack32 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord24 ), _BumpScale );
				unpack32.z = lerp( 1, unpack32.z, saturate(_BumpScale) );
				float3 unpack29 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DetailNormalMapScale, sampler_DetailNormalMapScale, texCoord11 ), _BumpScale1 );
				unpack29.z = lerp( 1, unpack29.z, saturate(_BumpScale1) );
				float3 lerpResult43 = lerp( unpack32 , unpack29 , packedInput.ase_color.a);
				
				float2 uv_Metallic = packedInput.ase_texcoord5.xy * _Metallic_ST.xy + _Metallic_ST.zw;
				float4 tex2DNode26 = SAMPLE_TEXTURE2D( _Metallic, sampler_Metallic, uv_Metallic );
				float4 tex2DNode14 = SAMPLE_TEXTURE2D( _MetallicGlossMap2, sampler_MetallicGlossMap2, texCoord11 );
				float lerpResult38 = lerp( ( tex2DNode26.r * _MetallicPower ) , ( tex2DNode14.r * _Float0 ) , packedInput.ase_color.a);
				
				float lerpResult44 = lerp( ( tex2DNode26.a * _SmoothnessPower ) , ( tex2DNode14.a * _Float1 ) , packedInput.ase_color.a);
				
				float lerpResult47 = lerp( ( tex2DNode26.g * _OcclusionStrength ) , ( tex2DNode14.g * _AmbientOcclusionPower ) , packedInput.ase_color.a);
				
				surfaceDescription.BaseColor = lerpResult41.rgb;
				surfaceDescription.Normal = lerpResult43;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = lerpResult38;
				...
				surfaceDescription.Occlusion = lerpResult47;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float3 unpack32 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord24 ), _BumpScale );
				unpack32.z = lerp( 1, unpack32.z, saturate(_BumpScale) );
				float2 texCoord11 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack29 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DetailNormalMapScale, sampler_DetailNormalMapScale, texCoord11 ), _BumpScale1 );
				unpack29.z = lerp( 1, unpack29.z, saturate(_BumpScale1) );
				float3 lerpResult43 = lerp( unpack32 , unpack29 , packedInput.ase_color.a);
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord24 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack32 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord24 ), _BumpScale );
				unpack32.z = lerp( 1, unpack32.z, saturate(_BumpScale) );
				float3 unpack29 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DetailNormalMapScale, sampler_DetailNormalMapScale, texCoord11 ), _BumpScale1 );
				unpack29.z = lerp( 1, unpack29.z, saturate(_BumpScale1) );
