	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode23 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, uv_MainTex );
				float2 texCoord11 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_35_0 = ( packedInput.ase_color.a / _Threshold );
				float4 lerpResult50 = lerp( ( tex2DNode23 * _Color0 ) , ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, texCoord11 ) * _Color ) , temp_output_35_0);
				
				float2 texCoord30 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack38 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord30 ), _BumpScale1 );
				unpack38.z = lerp( 1, unpack38.z, saturate(_BumpScale1) );
				float2 texCoord20 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack33 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap2, sampler_BumpMap2, texCoord20 ), _BumpScale2 );
				unpack33.z = lerp( 1, unpack33.z, saturate(_BumpScale2) );
				float3 lerpResult45 = lerp( unpack38 , unpack33 , temp_output_35_0);
				
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord5.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float4 tex2DNode29 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MetallicGlossMap, uv_MetallicGlossMap );
				float2 texCoord12 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode25 = SAMPLE_TEXTURE2D( _MetallicGlossMap2, sampler_MetallicGlossMap2, texCoord12 );
				float lerpResult47 = lerp( ( tex2DNode29.r * _MainMetallicPower3 ) , ( tex2DNode25.r * _MainMetallicPower4 ) , temp_output_35_0);
				
				float lerpResult48 = lerp( ( tex2DNode29.a * _MainSmoothnessPower3 ) , ( tex2DNode25.a * _MainSmoothnessPower4 ) , temp_output_35_0);
				
				float lerpResult42 = lerp( ( tex2DNode29.g * _OcclusionStrength3 ) , ( tex2DNode25.g * _OcclusionStrength4 ) , temp_output_35_0);
				
				surfaceDescription.BaseColor = lerpResult50.rgb;
				surfaceDescription.Normal = lerpResult45;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = lerpResult47;
				...
				surfaceDescription.Occlusion = lerpResult42;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode23 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, uv_MainTex );
				float2 texCoord11 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_35_0 = ( packedInput.ase_color.a / _Threshold );
				float4 lerpResult50 = lerp( ( tex2DNode23 * _Color0 ) , ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, texCoord11 ) * _Color ) , temp_output_35_0);
				...
				float3 unpack38 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord30 ), _BumpScale1 );
				unpack38.z = lerp( 1, unpack38.z, saturate(_BumpScale1) );
				float2 texCoord20 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack33 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap2, sampler_BumpMap2, texCoord20 ), _BumpScale2 );
				unpack33.z = lerp( 1, unpack33.z, saturate(_BumpScale2) );
				float3 lerpResult45 = lerp( unpack38 , unpack33 , temp_output_35_0);
				...
				float4 tex2DNode29 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MetallicGlossMap, uv_MetallicGlossMap );
				float2 texCoord12 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode25 = SAMPLE_TEXTURE2D( _MetallicGlossMap2, sampler_MetallicGlossMap2, texCoord12 );
				float lerpResult47 = lerp( ( tex2DNode29.r * _MainMetallicPower3 ) , ( tex2DNode25.r * _MainMetallicPower4 ) , temp_output_35_0);
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float3 unpack38 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord30 ), _BumpScale1 );
				unpack38.z = lerp( 1, unpack38.z, saturate(_BumpScale1) );
				float2 texCoord20 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack33 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap2, sampler_BumpMap2, texCoord20 ), _BumpScale2 );
				unpack33.z = lerp( 1, unpack33.z, saturate(_BumpScale2) );
				float temp_output_35_0 = ( packedInput.ase_color.a / _Threshold );
				float3 lerpResult45 = lerp( unpack38 , unpack33 , temp_output_35_0);
				...
				float4 tex2DNode29 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MetallicGlossMap, uv_MetallicGlossMap );
				float2 texCoord12 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode25 = SAMPLE_TEXTURE2D( _MetallicGlossMap2, sampler_MetallicGlossMap2, texCoord12 );
				float lerpResult48 = lerp( ( tex2DNode29.a * _MainSmoothnessPower3 ) , ( tex2DNode25.a * _MainSmoothnessPower4 ) , temp_output_35_0);
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode23 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, uv_MainTex );
				float2 texCoord11 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_35_0 = ( packedInput.ase_color.a / _Threshold );
				float4 lerpResult50 = lerp( ( tex2DNode23 * _Color0 ) , ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, texCoord11 ) * _Color ) , temp_output_35_0);
				...
				float3 unpack38 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord30 ), _BumpScale1 );
				unpack38.z = lerp( 1, unpack38.z, saturate(_BumpScale1) );
				float2 texCoord20 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack33 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap2, sampler_BumpMap2, texCoord20 ), _BumpScale2 );
				unpack33.z = lerp( 1, unpack33.z, saturate(_BumpScale2) );
				float3 lerpResult45 = lerp( unpack38 , unpack33 , temp_output_35_0);
				...
				float4 tex2DNode29 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MetallicGlossMap, uv_MetallicGlossMap );
				float2 texCoord12 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode25 = SAMPLE_TEXTURE2D( _MetallicGlossMap2, sampler_MetallicGlossMap2, texCoord12 );
				float lerpResult47 = lerp( ( tex2DNode29.r * _MainMetallicPower3 ) , ( tex2DNode25.r * _MainMetallicPower4 ) , temp_output_35_0);
